...
public class ReservaServiceTest{
    ...
    public void testdevolverSinFianza(){
		...
		ResponseEntity<Map<String, Object>> res = (ResponseEntity<Map<String, Object>>) reservaService.devolverSinFianza(r);
    ...
    public void testdevolverTodo(){
		...
		ResponseEntity<Map<String, Object>> res = (ResponseEntity<Map<String, Object>>) reservaService.devolverTodo(r);
    ...
    public void testFindByPlazaId(){
		...
		List<Reserva> reservaReturn = reservaService.findPlazaById(1l);
